...
; version 1.5 : moving all to alternate registers
...
; R0 : FFFFFFFC = 1111 1111 1111 1111 1111 1111 1111 1100

; R1 : source adresse sample 							channel 3
; R2 : source directe increment							channel 3
; R3 : source fin de sample								channel 3
; R4 : source registre externe paula fin de sample		channel 3	
; R5 : source registre externe paula debut sample		channel 3	

; R6 : source adresse sample 							channel 2
; R7 : source increment     							channel 2
; R8 : source fin de sample								channel 2
; R9 : source registre externe paula fin de sample		channel 2	
; R10 : source registre externe paula debut sample		channel 2	

; R11 : source adresse sample 							channel 1
; R12 : source increment     							channel 1
; R13 : source fin de sample							channel 1
; R14 : source registre externe paula fin de sample		channel 1	
; R15 : source registre externe paula debut sample		channel 1	

; R16 : source adresse sample 							channel 0
; R17 : source increment     							channel 0
; R18 : source fin de sample							channel 0
; R19 : source registre externe paula fin de sample		channel 0	
; R20 : source registre externe paula debut sample		channel 0	

; R21 : volume channel 3
; R22 : volume channel 2
; R23 : volume channel 1
; R24 : volume channel 0
...
; affiche les registres externes channel 0
...
; affiche les registres externes channel 1
...
; affiche les registres externes channel 2
...
; affiche les registres externes channel 3
...
; repeat voie 3	
	...
	movei		#LSP_DSP_repeat_length3,R8
...
; repeat voie 2
	...
	;store		R3,(R7)
	moveta		R3,R10
	;store		R4,(R8)					; stocke le pointeur sample de repeat dans LSP_DSP_PAULA_AUD2LEN
	moveta		R4,R9
	jump		(R12)				; jump en DSP_LSP_Timer1_skip3
	nop
...
; repeat voie 1
	...
	;store		R3,(R7)
	moveta		R3,R15
	;store		R4,(R8)					; stocke le pointeur sample de repeat dans LSP_DSP_PAULA_AUD1LEN
	moveta		R4,R14
	jump		(R12)				; jump en DSP_LSP_Timer1_skip3
	nop
...
; repeat voie 0
	...
	;store		R3,(R7)
	moveta		R3,R20
	;store		R4,(R8)					; stocke le pointeur sample de repeat dans LSP_DSP_PAULA_AUD0LEN
	moveta		R4,R19
	jump		(R12)				; jump en DSP_LSP_Timer1_skip3
	nop
...
chaine_LSP:						dc.b	"LSP player for Jaguar  v1.5",10,0
